...
class Net(nn.Module):
    def __init__(self, model_name, mode):
        ...
        if model_name == 'DNANet':
            ...
            self.model = ALCNet()
        elif model_name == 'MLCLNet':
            self.model = MLCLNet()
        elif model_name == 'GGLNet':
            if mode == 'train':
                self.model = GGLNet(mode='train')
            else:
                self.model = GGLNet(mode='test')
        elif model_name == 'ALCLNet':
            self.model = ALCLNet()
        elif model_name == 'MLCLNet_base':
            self.model = MLCLNet_base()
        elif model_name == 'MLCLNet_small':
            self.model = MLCLNet_small()
